            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="display_name" value="<?= $data->user->display_name ?>">
                    </div>
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <input type="password" class="form-control" name="password" value="<?= $data->user->password ?>">
                    <div class="col-md-12 mt-3">
                        <label class="labels">New Password</label>
                        <input type="password" class="form-control" name="new-password">
                </div>
                <button type="submit" class="btn btn-warning mt-3">Update</button>
                                <a href="/user/profile?id=<?= $data->user->id ?>"><button type="button" class="btn btn-danger mt-3 ms-1">back</button></a>
                            </div>
        </div>
