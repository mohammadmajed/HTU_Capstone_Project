      ...
      <div class="col-md-12 col-xl-4">
        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body text-center">
            ...
            <h4 class="mb-2"><?= $data->info->username ?></h4>
            <p class="text-muted mb-4"><?= $data->info->display_name ?> <span class="mx-2">|</span> 
            <a href="#!"><?= $data->info->email ?></a></p>
                <a href="/users/edit_profile?id=<?= $data->info->id ?>">
            ...
            <div class="d-flex justify-content-evenly text-center mt-3 mb-2">
              ...
              <p class="text-muted mb-0">Created At</p>
                <p class="mb-2 h5"><?= $data->info->created_at ?></p>
                
              </div>
              <div class="px-3">
              <p class="text-muted mb-0">Updated At</p>
                <p class="mb-2 h5"><?= $data->info->updated_at ?></p>
              </div>
            </div>
          </div>
        </div>
